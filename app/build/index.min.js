...
"use strict";var generateColor=function generateColor(){return"#".concat(Math.floor(Math.random()*16777215).toString(16));};var updateColor=function updateColor(element,updateTime){return setInterval(function(){return element.style.backgroundColor=generateColor();},updateTime);};

"use strict";var params={lines:[{background:'#2B4162',updateTime:1000,elements:[{background:'#721817',width:25},{background:'#E4B363',width:50},{background:'#2B4162',width:25}]},{background:'#721817',updateTime:3000,elements:[{background:'#84ACCE',width:35},{background:'#E0DFD5',width:20},{background:'#AB87FF',width:45}]},{background:'#84ACCE',updateTime:2000,elements:[{background:'#0B6E4F',width:65},{background:'#454955',width:35}]},{background:'#E4B363',updateTime:1500,elements:[{background:'#E0DFD5',width:10},{background:'#454955',width:25},{background:'#84ACCE',width:40},{background:'#721817',width:25}]}]};

"use strict";var stylizeLine=function stylizeLine(element,display,width,height,backgroundColor){element.style.display=display;element.style.width=width;element.style.height=height;element.style.backgroundColor=backgroundColor;};var render=function render(){var root=document.getElementById('root');var lines=params.lines;lines.map(function(item){var line=document.createElement('div');var lineElements=item.elements;var updateTime=item.updateTime;stylizeLine(line,'block','100%',"".concat(100/lines.length,"%"),item.background);updateColor(line,updateTime);lineElements.map(function(item){var lineElement=document.createElement('div');stylizeLine(lineElement,'inline-block',"".concat(item.width,"%"),'100%',item.background);updateColor(lineElement,updateTime);line.appendChild(lineElement);});root.appendChild(line);});var body=document.body;body.style.margin=0;body.style.padding=0;root.style.height='100vh';};window.addEventListener('load',render);